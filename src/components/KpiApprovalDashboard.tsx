...
import { CheckCircle, XCircle, Clock, Search, Filter, Eye, AlertCircle, RotateCcw, BarChart3 } from 'lucide-react';
...
const KpiApprovalDashboard: React.FC = () => {
  ...
  const { getAvailableActions, requiresComment, getStateInfo, workflowHistory } = useKpiWorkflow();
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="requests" className="space-y-6">
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="requests">Approval Queue</TabsTrigger>
        ...
        <TabsContent value="analytics" className="space-y-6">
          <div className="text-center p-8 bg-blue-50 rounded-lg">
            ...
            <p className="text-gray-600 mb-4">View detailed analytics and insights in the dedicated Analytics page</p>
